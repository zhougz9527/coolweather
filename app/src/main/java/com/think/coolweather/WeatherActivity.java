...
//                Toast.makeText(WeatherActivity.this, "加载图片失败", Toast.LENGTH_SHORT).show();
                Snackbar.make(getWindow().getDecorView(),"加载图片失败" ,Snackbar.LENGTH_SHORT).show();
            }
...
//                        Toast.makeText(WeatherActivity.this, "获取天气信息失败", Toast.LENGTH_SHORT).show();
                        Snackbar.make(getWindow().getDecorView(),"获取天气数据失败" ,Snackbar.LENGTH_SHORT).show();
